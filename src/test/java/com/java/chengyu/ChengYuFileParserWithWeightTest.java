...
public class ChengYuFileParserWithWeightTest extends TestCase
{
    ...
    */
   public ChengYuFileParserWithWeightTest(String testName)
   {
      super(testName);
   }
   ...
   {
      return new TestSuite(ChengYuFileParserWithWeightTest.class);
   }
   ...
   public void testParseNormal()
   {
      ...
      sb.append("风风云云 fēng fēng yún yún 11 \r\n");
      sb.append("大大小小 dà dà xiǎo xiǎo 22\r\n");
      ...
      ChengYuFileParserWithWeight parser = new ChengYuFileParserWithWeight();
      ...
      Assert.assertEquals("ChengYu count wrong", 2, result.getSize() );  
   }
   ...
   {
      StringBuilder sb = new StringBuilder();
      sb.append("风风云云   fēng fēng yún yún  1234\r\n");
      sb.append("大大小小  dà dà xiǎo xiǎo 345");
